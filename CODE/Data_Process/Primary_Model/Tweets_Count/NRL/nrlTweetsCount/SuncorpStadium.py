...
var a = new Date(Date.parse("Thu Sep 03 00:00:00 +0000 2015"));
var b = new Date(Date.parse("Fri Sep 04 00:00:00 +0000 2015"));
var t = new Date(Date.parse(doc.created_at));
var locations = [153.002732,-27.470839,153.016545,-27.45885]
if((t>a)&&(t<b)){
