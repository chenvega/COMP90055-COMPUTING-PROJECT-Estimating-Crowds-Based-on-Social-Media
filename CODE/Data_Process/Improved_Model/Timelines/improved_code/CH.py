...
if((t>a)&&(t<b)){
	if(doc.coordinates != null){
		...
		if((lo>-0.198013)&&(la>51.477107)&&(lo<-0.183556)&&(la<51.486299)){
...
with open('/Users/jacky/Desktop/upload/improve/CH0829H.csv', 'w') as fw:
...
with open('/Users/jacky/Desktop/upload/improve/CH0919H.csv', 'w') as fw:
	writer = csv.writer(fw,lineterminator='\n')
	for key, value in dic.items():
		writer.writerow([key,value])
...
with open('/Users/jacky/Desktop/upload/improve/CH1003H.csv', 'w') as fw:
	writer = csv.writer(fw,lineterminator='\n')
	for key, value in dic.items():
		writer.writerow([key,value])