...
if((t>a)&&(t<b)){
	if(doc.coordinates != null){
		...
		if((lo>-0.072195)&&(la>51.599038)&&(lo<-0.059026)&&(la<51.607413)){
...
with open('/Users/jacky/Desktop/upload/improve/TO0829H.csv', 'w') as fw:
...
with open('/Users/jacky/Desktop/upload/improve/TO0926H.csv', 'w') as fw:
	writer = csv.writer(fw,lineterminator='\n')
	for key, value in dic.items():
		writer.writerow([key,value])
...
with open('/Users/jacky/Desktop/upload/improve/TO0920H.csv', 'w') as fw:
	writer = csv.writer(fw,lineterminator='\n')
	for key, value in dic.items():
		writer.writerow([key,value])