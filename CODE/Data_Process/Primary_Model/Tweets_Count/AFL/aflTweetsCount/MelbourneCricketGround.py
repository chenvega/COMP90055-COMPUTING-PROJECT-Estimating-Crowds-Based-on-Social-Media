...
mapFunc = '''function(doc) {
var a = new Date(Date.parse("Mon Aug 31 00:00:00 +0000 2015"));
var b = new Date(Date.parse("Tue Sep 01 00:00:00 +0000 2015"));
var t = new Date(Date.parse(doc.created_at));
if((t>a)&&(t<b)){
	if(doc.coordinates != null){
		var la = doc.coordinates.coordinates[1];
		var lo = doc.coordinates.coordinates[0];
		if((lo>144.974135)&&(la>-37.827536)&&(lo<144.992792)&&(la<-37.812175)){
			emit(doc.user.id, 1);
		}
	}
