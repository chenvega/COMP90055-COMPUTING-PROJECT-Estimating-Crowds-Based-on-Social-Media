  ...
  <meta charset="utf-8">
   ...
   <script>
    function getAway(str)
    {
      ...
      xmlhttp.open("GET","predictFilter_Eng/away.php?home="+str,true);
      xmlhttp.send();
    }
    ...
    function getStadium(str)
    {
      ...
      xmlhttp.open("GET","predictFilter_Eng/stadium.php?home="+str,true);
      xmlhttp.send();
    }
    ...
    function getDate(str)
    {
      ...
      xmlhttp.open("GET","predictFilter_Eng/date.php?comb="+str,true);
      xmlhttp.send();
    }
   </script>
...
<form role="form" action="predictFilter_Eng/predictResult.php" method="POST">
  <div class="form-group col-md-6">
    <label for="home">HOME</label>
    <select class="form-control" id="home" name="home" onchange="getAway(this.value);getStadium(this.value)" required>
