...
with open('/Users/jacky/Desktop/upload/improve/LI0829H.csv', 'w') as fw:
...
with open('/Users/jacky/Desktop/upload/improve/LI0920H.csv', 'w') as fw:
	writer = csv.writer(fw,lineterminator='\n')
	for key, value in dic.items():
		writer.writerow([key,value])
...
with open('/Users/jacky/Desktop/upload/improve/LI0926H.csv', 'w') as fw:
	writer = csv.writer(fw,lineterminator='\n')
	for key, value in dic.items():
		writer.writerow([key,value])