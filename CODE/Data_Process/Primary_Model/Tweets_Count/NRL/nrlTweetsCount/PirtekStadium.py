...
var a = new Date(Date.parse("Sun Sep 06 00:00:00 +0000 2015"));
var b = new Date(Date.parse("Mon Sep 07 00:00:00 +0000 2015"));
var t = new Date(Date.parse(doc.created_at));
var locations = [150.993832,-33.813073,151.005671,-33.803207]
if((t>a)&&(t<b)){
