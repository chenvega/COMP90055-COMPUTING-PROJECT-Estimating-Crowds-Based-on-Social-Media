...
if((t>a)&&(t<b)){
	if(doc.coordinates != null){
		...
		if((lo>-1.395556)&&(la>54.910276)&&(lo<-1.380799)&&(la<54.918648)){
...
with open('/Users/jacky/Desktop/upload/improve/SL0822H.csv', 'w') as fw:
...
with open('/Users/jacky/Desktop/upload/improve/SL0913H.csv', 'w') as fw:
	writer = csv.writer(fw,lineterminator='\n')
	for key, value in dic.items():
		writer.writerow([key,value])
...
with open('/Users/jacky/Desktop/upload/improve/SL1003H.csv', 'w') as fw:
	writer = csv.writer(fw,lineterminator='\n')
	for key, value in dic.items():
		writer.writerow([key,value])