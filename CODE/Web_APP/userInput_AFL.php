  ...
  <meta charset="utf-8">
   ...
   <script>
    function getAway(str)
    {
      ...
      xmlhttp.open("GET","predictFilter_AFL/away.php?home="+str,true);
      xmlhttp.send();
    }
    ...
    function getStadium(str)
    {
      ...
      xmlhttp.open("GET","predictFilter_AFL/stadium.php?comb="+str,true);
      xmlhttp.send();
    }
    ...
    function getDate(str)
    {
      ...
      xmlhttp.open("GET","predictFilter_AFL/date.php?comb="+str,true);
      xmlhttp.send();
    }
   </script>
...
<form role="form" action="predictFilter_AFL/predictResult.php" method="POST">
