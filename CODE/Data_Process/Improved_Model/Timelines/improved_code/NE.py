...
with open('/Users/jacky/Desktop/upload/improve/NE0829H.csv', 'w') as fw:
...
with open('/Users/jacky/Desktop/upload/improve/NE0919H.csv', 'w') as fw:
	writer = csv.writer(fw,lineterminator='\n')
	for key, value in dic.items():
		writer.writerow([key,value])
...
with open('/Users/jacky/Desktop/upload/improve/NE0926H.csv', 'w') as fw:
	writer = csv.writer(fw,lineterminator='\n')
	for key, value in dic.items():
		writer.writerow([key,value])