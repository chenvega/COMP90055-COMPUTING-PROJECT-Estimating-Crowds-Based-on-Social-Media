...
if((t>a)&&(t<b)){
	if(doc.coordinates != null){
		...
		if((lo>-1.891539)&&(la>52.504497)&&(lo<-1.877984)&&(la<52.512942)){
...
with open('/Users/jacky/Desktop/upload/improve/AV0829H.csv', 'w') as fw:
...
with open('/Users/jacky/Desktop/upload/improve/AV0919H.csv', 'w') as fw:
	writer = csv.writer(fw,lineterminator='\n')
	for key, value in dic.items():
		writer.writerow([key,value])
...
with open('/Users/jacky/Desktop/upload/improve/AV1003H.csv', 'w') as fw:
	writer = csv.writer(fw,lineterminator='\n')
	for key, value in dic.items():
		writer.writerow([key,value])