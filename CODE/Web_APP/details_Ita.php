...
// This program will show detailed information of Italy 
// Football League
<!DOCTYPE html>
<html>
<head>
...
<!-- Nav ends -->
    ...
    <div>
      ...
      <div class="col-md-10">
        ...
        <?php
          echo "
          <img src=\"./image/photos/italy/".$team."\" style=\"height:40px; width: auto; vertical-align:text-bottom;\"/>&nbsp;<span style=\"font-size: 50px; \">Match History</span>";
        ?>
        </div>
                ...
                if($teamName == $content["rows"][$i]["key"][0] || $teamName == $content["rows"][$i]["key"][1]){
                  echo "
                        <tr>
                          ...
                          <td><img src=\"./image/photos/italy/".$content["rows"][$i]["key"][0].".png\" style=\"height:40px; width: auto; vertical-align:text-bottom;\"/></td>
                          <td><img src=\"./image/photos/italy/".$content["rows"][$i]["key"][1].".png\" style=\"height:40px; width: auto; vertical-align:text-bottom;\"/></td>
