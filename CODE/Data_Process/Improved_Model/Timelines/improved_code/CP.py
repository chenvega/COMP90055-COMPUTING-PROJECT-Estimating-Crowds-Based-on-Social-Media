...
if((t>a)&&(t<b)){
	if(doc.coordinates != null){
		...
		if((lo>-0.09164)&&(la>51.394093)&&(lo<-0.079244)&&(la<51.40244)){
			emit(doc.user.id, 1);
		}
	}
...
with open('/Users/jacky/Desktop/upload/improve/CP0822H.csv', 'w') as fw:
...
with open('/Users/jacky/Desktop/upload/improve/CP0912H.csv', 'w') as fw:
	writer = csv.writer(fw,lineterminator='\n')
	for key, value in dic.items():
		writer.writerow([key,value])
...
with open('/Users/jacky/Desktop/upload/improve/CP1003H.csv', 'w') as fw:
	writer = csv.writer(fw,lineterminator='\n')
	for key, value in dic.items():
		writer.writerow([key,value])