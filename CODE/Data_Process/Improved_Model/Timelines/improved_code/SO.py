...
if((t>a)&&(t<b)){
	if(doc.coordinates != null){
		...
		if((lo>-1.397348)&&(la>50.901796)&&(lo<-1.384308)&&(la<50.909825)){
...
with open('/Users/jacky/Desktop/upload/improve/SO0830H.csv', 'w') as fw:
...
mapFunc = '''function(doc) {
var a = new Date(Date.parse("Sun Sep 20 00:00:00 +0000 2015"));
var b = new Date(Date.parse("Mon Sep 21 00:00:00 +0000 2015"));
var t = new Date(Date.parse(doc.created_at));
if((t>a)&&(t<b)){
	if(doc.coordinates != null){
		var la = doc.coordinates.coordinates[1];
...
with open('/Users/jacky/Desktop/upload/improve/SO0920H.csv', 'w') as fw:
	writer = csv.writer(fw,lineterminator='\n')
	for key, value in dic.items():
		writer.writerow([key,value])
...
with open('/Users/jacky/Desktop/upload/improve/SO0926H.csv', 'w') as fw:
	writer = csv.writer(fw,lineterminator='\n')
	for key, value in dic.items():
		writer.writerow([key,value])