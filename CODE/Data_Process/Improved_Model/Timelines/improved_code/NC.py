...
if((t>a)&&(t<b)){
	if(doc.coordinates != null){
		...
		if((lo>1.302832)&&(la>52.618359)&&(lo<1.315541)&&(la<52.625693)){
...
with open('/Users/jacky/Desktop/upload/improve/NC0822H.csv', 'w') as fw:
...
with open('/Users/jacky/Desktop/upload/improve/NC0912H.csv', 'w') as fw:
	writer = csv.writer(fw,lineterminator='\n')
	for key, value in dic.items():
		writer.writerow([key,value])
...
with open('/Users/jacky/Desktop/upload/improve/NC1003H.csv', 'w') as fw:
	writer = csv.writer(fw,lineterminator='\n')
	for key, value in dic.items():
		writer.writerow([key,value])