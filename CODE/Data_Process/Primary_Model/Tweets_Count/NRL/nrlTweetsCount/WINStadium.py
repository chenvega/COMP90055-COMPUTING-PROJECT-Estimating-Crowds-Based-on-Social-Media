...
var a = new Date(Date.parse("Thu Aug 20 00:00:00 +0000 2015"));
var b = new Date(Date.parse("Fri Aug 21 00:00:00 +0000 2015"));
var t = new Date(Date.parse(doc.created_at));
var locations = [150.897075,-34.432117,150.908141,-34.423773]
if((t>a)&&(t<b)){
