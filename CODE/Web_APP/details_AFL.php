...
// This program will show detailed information of AFL 
// Football League
<!DOCTYPE html>
<html>
<head>
...
<!-- Nav ends -->
    ...
    <div>
      ...
      <div class="col-md-10">
        ...
        <?php
          echo "
          <img src=\"./image/photos/AFL/".$team."\" style=\"height:40px; width: auto; vertical-align:text-bottom;\"/>&nbsp;<span style=\"font-size: 50px; \">Match History</span>";
        ?>
        </div>
         ...
         <div>
          <?php
              $handle = fopen("http://115.146.85.185:5984/afldatanew/_design/afldatanew/_view/afldatanew","rb");
              $content = "";
              while(!feof($handle)){
                ...
                if($teamName == $content["rows"][$i]["key"][0] || $teamName == $content["rows"][$i]["key"][1]){
                  echo "
                        <tr>
                          ...
                          <td><img src=\"./image/photos/AFL/".$content["rows"][$i]["key"][0].".png\" style=\"height:40px; width: auto; vertical-align:text-bottom;\"/></td>
                          <td><img src=\"./image/photos/AFL/".$content["rows"][$i]["key"][1].".png\" style=\"height:40px; width: auto; vertical-align:text-bottom;\"/></td>
