  ...
  <meta charset="utf-8">
   ...
   <script>
    function getAway(str)
    {
      ...
      xmlhttp.open("GET","predictFilter_Spa/away.php?home="+str,true);
      xmlhttp.send();
    }
    ...
    function getStadium(str)
    {
      ...
      xmlhttp.open("GET","predictFilter_Spa/stadium.php?home="+str,true);
      xmlhttp.send();
    }
    ...
    function getDate(str)
    {
      ...
      xmlhttp.open("GET","predictFilter_Spa/date.php?comb="+str,true);
      xmlhttp.send();
    }
   </script>
...
<form role="form" action="predictFilter_Spa/predictResult.php" method="POST">
