...
var a = new Date(Date.parse("Fri Sep 04 00:00:00 +0000 2015"));
var b = new Date(Date.parse("Sat Sep 05 00:00:00 +0000 2015"));
var t = new Date(Date.parse(doc.created_at));
var locations = [151.2187149747,-33.8944236231,151.2320773983,-33.8838525699]
if((t>a)&&(t<b)){
