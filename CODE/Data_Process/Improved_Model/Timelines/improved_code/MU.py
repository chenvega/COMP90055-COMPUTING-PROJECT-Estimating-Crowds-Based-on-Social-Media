...
var locations = [-2.301658,53.457008,-2.281065,53.469236]
if((t>a)&&(t<b)){
...
with open('/Users/jacky/Desktop/upload/improve/MU0822H.csv', 'w') as fw:
...
with open('/Users/jacky/Desktop/upload/improve/MU0912H.csv', 'w') as fw:
	writer = csv.writer(fw,lineterminator='\n')
	for key, value in dic.items():
		writer.writerow([key,value])
...
with open('/Users/jacky/Desktop/upload/improve/MU0926H.csv', 'w') as fw:
	writer = csv.writer(fw,lineterminator='\n')
	for key, value in dic.items():
		writer.writerow([key,value])